const VulcanCoreContract = artifacts.require("VulcanCore");
...
module.exports = function(deployer, network) {
    ...
    deployer
        .deploy(VulcanCoreContract)
        .then(() => {
            return deployer.deploy(DappStateContract, VulcanCoreContract.address);
        })
        .then(() => {
        ...
        .then(() => {
            let config = {
                httpUri: httpUri,
                wsUri: wsUri,
                vulcanCoreContractAddress: VulcanCoreContract.address,
